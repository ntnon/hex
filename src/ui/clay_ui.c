...
// }; const Clay_Color COLOR_OVERLAY = (Clay_Color){ 0, 0, 0, 150 }; const
// Clay_Color COLOR_PANEL = (Clay_Color){ 80, 80, 80, 255 }; const Clay_Color
// COLOR_TEXT_DARK = (Clay_Color){ 0, 0, 0, 255 }; const Clay_Color
// COLOR_TEXT_LIGHT = (Clay_Color){ 255, 255, 255, 255 };

// // Forward declarations
// void HandleClayErrorsO (Clay_ErrorData errorData);
...
//                    (Clay_ErrorHandler){ HandleClayErrorsO });

//   Clay_SetMeasureTextFunction (Clay_Raylib_MeasureText, NULL);
