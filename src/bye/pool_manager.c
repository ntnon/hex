#include "../../include/bye/pool_manager.h"
...
void pool_manager_clear(pool_manager_t *pm) { pool_map_free(pm->pool_map); }
...
size_t pool_map_filter_by_tile_type(pool_t **pool_candidates,
...
pool_t *pool_manager_merge_pools(pool_manager_t *pm,
  ...
  for (size_t i = 0; i < num_pools; i++) {
    ...
    tile_to_pool_map_reassign_pool(tile_to_pool_map, source_pool, target_pool);
...
void pool_manager_add_tile_to_pool(pool_manager_t *pm, pool_t *pool,
                                   tile_t *tile) {
