...
void
print_grid_cell (const grid_cell_t *cell)
{
  char buffer[32];
...
void
grid_cell_to_string (const grid_cell_t *cell, char *buffer, size_t buffer_size)
{
...
bool
grid_cells_equal (const grid_cell_t *a, const grid_cell_t *b)
{
