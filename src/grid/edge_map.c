...
edge_map_entry_t *edge_map_create(void) { return NULL; }
...
void edge_map_clear(edge_map_entry_t **map_root) { HASH_CLEAR(hh, *map_root); };
...
void corners_to_edges(point_t corners[6], edge_map_entry_t **edge_map_root) {
  for (int i = 0; i < 6; ++i) {
...
void get_cell_edges(const grid_t *grid, grid_cell_t cell,
