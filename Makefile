...
hex: raylib
ifneq (,$(hex_config))
	@echo "==== Building hex ($(hex_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f hex.make config=$(hex_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f hex.make clean
