...
hexhex: raylib
ifneq (,$(hexhex_config))
	@echo "==== Building hexhex ($(hexhex_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f hexhex.make config=$(hexhex_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f hexhex.make clean
